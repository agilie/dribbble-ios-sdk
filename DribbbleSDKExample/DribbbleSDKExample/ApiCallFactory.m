...
+ (NSArray *)demoApiCallWrappers {
    ...
    NSArray *apiCallWrappers = [NSArray arrayWithObjects:
                                ...
                                [ApiCallFactory apiCallWrapperWithTitle:@"Upload comment" selector:@selector(uploadCommentWithShot:withBody:responseHandler:) args:@[[AppDelegate delegate].shot.shotId ?: kDemoShotId, @"API test comment"] responseHandler:sharedHandler],
                                
                                [ApiCallFactory apiCallWrapperWithTitle:@"Update comment (upload & restart first)" selector:@selector(updateCommentWith:forShot:withBody:responseHandler:) args:@[[AppDelegate delegate].comment.commentId ?: kDemoCommentId, [AppDelegate delegate].shot.shotId ?: kDemoShotId, @"API test updated comment"] responseHandler:sharedHandler],
                                [ApiCallFactory apiCallWrapperWithTitle:@"Delete comment (upload & restart first)" selector:@selector(deleteCommentWith:forShot:responseHandler:) args:@[[AppDelegate delegate].comment.commentId ?: kDemoCommentId, [AppDelegate delegate].shot.shotId ?: kDemoShotId] responseHandler:sharedHandler],
                                ...
                                [ApiCallFactory apiCallWrapperWithTitle:@"Load attach (restart after upload)" selector:@selector(loadAttachmentWith:forShot:params:responseHandler:) args:@[[AppDelegate delegate].attachment.attachmentId ?: @(0), [AppDelegate delegate].shot.shotId ?: kDemoShotId, @{}] responseHandler:sharedHandler],
                                [ApiCallFactory apiCallWrapperWithTitle:@"Load attach-s with shot (restart after upload)" selector:@selector(loadAttachmentsWithShot:params:responseHandler:) args:@[[AppDelegate delegate].shot.shotId ?: kDemoShotId, @{}] responseHandler:sharedHandler],
